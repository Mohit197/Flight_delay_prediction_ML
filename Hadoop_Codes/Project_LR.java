...
public class LogisticRegressionMapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        // Emit key-value pair: key is a unique identifier, value is the computed model parameters
        context.write(new Text("model"), new DoubleWritableArrayWritable(weights));
    }
